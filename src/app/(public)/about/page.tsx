...
export const metadata = {
  ...
  openGraph: {
    title: "About — King Bloggers",
    description: "A sovereign Nigerian media platform for Tech, Art, Culture, Politics, Economics, and Religion.",
    images: ["/icons/og.png"],
  },
};
    ...
    <main className="min-h-screen py-14">
      <Container>
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-8">
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-foreground/70 leading-relaxed">
              To build Africa&apos;s most trusted media space — where readers discover authentic Nigerian voices and bloggers publish with clarity, authority, and zero distraction. We believe every Nigerian story deserves a world-class platform.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-foreground/70 leading-relaxed">
              A premium publishing ecosystem that elevates Nigerian storytelling to world-class standards — mobile-optimised, offline-capable, and designed for the sovereign reader. We&apos;re building the future of African digital media.
            </p>
          </GlassCard>
        </div>
        ...
        <GlassCard className="p-8 md:p-10 mb-8">
          <h3 className="text-xl font-black mb-6">Built by Nigerians, for Nigerians</h3>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="text-center p-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-king-orange/20 flex items-center justify-center text-2xl mb-3">👨‍💻</div>
              <div className="font-bold">Engineering</div>
              <p className="text-sm text-foreground/60 mt-1">Lagos-based tech team building with Next.js, React, and edge computing</p>
            </div>
            <div className="text-center p-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-king-gold/20 flex items-center justify-center text-2xl mb-3">✍️</div>
              <div className="font-bold">Editorial</div>
              <p className="text-sm text-foreground/60 mt-1">Curating quality content across Tech, Culture, Politics, and more</p>
            </div>
            <div className="text-center p-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-green-500/20 flex items-center justify-center text-2xl mb-3">🌍</div>
              <div className="font-bold">Community</div>
              <p className="text-sm text-foreground/60 mt-1">Growing a network of bloggers and readers across all 36 states + FCT</p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard className="p-8 md:p-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: "Auth & Security", desc: "Email + Google login with NextAuth v5 and secure JWT sessions." },
              { title: "Lightning Fast", desc: "Next.js 15 App Router, edge-ready, streaming SSR for instant loads." },
            ].map((f) => (
              <div key={f.title} className="rounded-xl border border-foreground/10 bg-foreground/5 p-5 hover:bg-foreground/10 transition-colors">
        ...
        <div className="mt-10 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <Link href="/contact" className="text-sm text-foreground/60 hover:text-king-orange transition-colors">Contact Us</Link>
