            ...
            <div className="sticky top-24">
              <GlassCard className="p-4">
                ...
                <nav className="space-y-1">
                  ...
                  <TOCLink href="#create-account">
                    Creating Your Account
                  </TOCLink>
                  <TOCLink href="#writing-posts">
                  ...
                  <TOCLink href="#geo-targeting">
                    Geo-Targeting (States & LGAs)
                  </TOCLink>
          ...
          <div className="space-y-12">
            <GlassCard className="p-6 md:p-10">
              <DocSection id="getting-started" title="Getting Started">
                <p>
                  Welcome to <strong>King Bloggers</strong> — a sovereign
                  Nigerian media platform built for speed, clarity, and
                  mobile-first reading. Whether you&apos;re a reader discovering
                  fresh content or a blogger publishing your voice, this guide
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>
                    Use the theme toggle (☀️/🌙) to switch between light and
                    dark modes
                  </li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>
                    ...
                    <Link
                      href="/register"
                      className="text-king-orange underline"
                    >
                      /register
                    </Link>
                  </li>
                  <li>
                    Log in and access your <strong>Blogger Studio</strong>
                  </li>
                  <li>
                    Write, edit, and publish posts with the rich-text editor
                  </li>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="create-account" title="Creating Your Account">
                <p>
                  To publish on King Bloggers, you need a blogger account.
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>
                    ...
                    <strong>email</strong>, <strong>phone number</strong>, and
                    create a <strong>password</strong>
                  </li>
                  <li>
                    Select your <strong>State</strong> and <strong>LGA</strong>{" "}
                    from the dropdown (we support all 774 Nigerian LGAs)
                  </li>
                  <li>
                    Click <strong>&ldquo;Create Account&rdquo;</strong>
                  </li>
                  <li>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="writing-posts" title="Writing & Publishing Posts">
                <p>
                  The Blogger Studio includes a powerful rich-text editor for
                  creating beautiful posts.
                </p>
                <h3 className="text-lg font-bold mt-6 mb-2">
                  Creating a New Post
                </h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>
                    Navigate to <strong>Blogger Studio → Editor</strong> (or
                    click &ldquo;Open Studio&rdquo; from the navbar)
                  </li>
                  <li>
                    Enter your <strong>Title</strong>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    1200×630px for best social sharing)
                  </li>
                  <li>
                    Write your content using the rich-text toolbar (bold,
                    italic, headings, lists, links, code, etc.)
                  </li>
                  <li>
                    Click <strong>&ldquo;Save Draft&rdquo;</strong> to save
                    without publishing, or{" "}
                    <strong>&ldquo;Publish&rdquo;</strong> to go live
                  </li>
                </ol>
                <CalloutBox type="info" title="Cover Images">
                  High-quality cover images make your posts stand out. Use
                  landscape images for best results on cards and social shares.
                </CalloutBox>
              </DocSection>
            </GlassCard>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="blogger-dashboard" title="Blogger Dashboard">
                <p>
                  Your Dashboard provides real-time analytics and management
                  tools for your blogging activity.
                </p>
                <h3 className="text-lg font-bold mt-6 mb-2">
                  Dashboard Features
                </h3>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong>Total Posts:</strong> Count of all posts you&apos;ve
                    created
                  </li>
                  <li>
                    <strong>Published:</strong> Number of live, published posts
                  </li>
                  <li>
                    <strong>Comments:</strong> Total comments received on your
                    posts
                  </li>
                  <li>
                    <strong>Activity Chart:</strong> 10-day publishing trend
                    visualization
                  </li>
                  <li>
                    <strong>Quick Actions:</strong> Access to Editor, Posts
                    list, and Settings
                  </li>
                </ul>
              </DocSection>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="pwa-install" title="Installing the PWA">
                <p>
                  King Bloggers is a <strong>Progressive Web App (PWA)</strong>{" "}
                  — you can install it on your device for an app-like experience
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>
                    Look for the <strong>&ldquo;Install App&rdquo;</strong>{" "}
                    prompt at the bottom of the screen
                  </li>
                  <li>
                    Click <strong>&ldquo;Install App&rdquo;</strong> and confirm
                  </li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>
                    Confirm by tapping <strong>&ldquo;Add&rdquo;</strong>
                  </li>
                </ol>
                <CalloutBox type="tip" title="Offline Support">
                  Once installed, the PWA caches key assets so you can browse
                  previously loaded pages even without internet.
                </CalloutBox>
              </DocSection>
            </GlassCard>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="themes" title="Light & Dark Themes">
                <p>
                  King Bloggers supports both <strong>Light</strong> and{" "}
                  <strong>Dark</strong> modes for comfortable reading in any
                  environment.
                </p>
                <ul className="list-disc pl-5 space-y-2 mt-4">
                  <li>
                    Click the <strong>☀️/🌙</strong> toggle in the navbar to
                    switch themes
                  </li>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection
                id="geo-targeting"
                title="Geo-Targeting (States & LGAs)"
              >
                <p>
                  King Bloggers captures your Nigerian <strong>State</strong>{" "}
                  and <strong>Local Government Area (LGA)</strong> during
                  registration. This enables:
                </p>
                <ul className="list-disc pl-5 space-y-2 mt-4">
                ...
                <p className="mt-4">
                  We support all <strong>37 states</strong> and{" "}
                  <strong>774 LGAs</strong> in Nigeria.
                </p>
              </DocSection>
            </GlassCard>
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="community" title="Community Guidelines">
                <p>
                  King Bloggers is a space for respectful, authentic Nigerian
                  voices. We expect all users to:
                </p>
                <ul className="list-disc pl-5 space-y-2 mt-4">
                ...
                <CalloutBox type="warning" title="Content Moderation">
                  Posts or accounts violating these guidelines may be removed
                  without notice.
                </CalloutBox>
              </DocSection>
            </GlassCard>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-foreground/70 mt-1">
                      Yes! Reading and publishing are completely free. Premium
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 mt-1">
                      Yes. From your Blogger Studio, go to &ldquo;My
                      Posts&rdquo; to edit or delete any of your content.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold">How do I change my password?</h3>
                    <p className="text-foreground/70 mt-1">
                      Visit Settings in your Blogger Studio to update your
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 mt-1">
                      Currently, King Bloggers supports images. Video embedding
                      (YouTube, etc.) may be added in future updates.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold">Is my data secure?</h3>
                    <p className="text-foreground/70 mt-1">
                      We use industry-standard encryption and secure
            ...
            <GlassCard className="p-6 md:p-10">
              <DocSection id="support" title="Support & Contact">
                ...
                <div className="grid gap-4 sm:grid-cols-2 mt-6">
                  <div className="rounded-xl border border-foreground/10 bg-foreground/5 p-5">
                    ...
                    <a
                      ...
                      className="text-king-orange underline text-sm"
                    >
                ...
                <p className="mt-6">
                  Visit our{" "}
                  <Link href="/contact" className="text-king-orange underline">
                    Contact page
                  </Link>{" "}
