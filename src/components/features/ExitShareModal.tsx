...
export function ExitShareModal() {
  ...
  const shareUrl = typeof window !== "undefined" ? window.location.origin : "https://kingbloggers.com";
  const shareTitle = "King Bloggers – The Sovereign Blogging Platform";
  const shareText = "Discover intelligent content from verified creators on King Bloggers. Join the movement!";
              ...
              <div className="p-5">
                ...
                <div className="mb-4 pr-8">
                  ...
                  <p className="mt-1 text-sm text-white/60">
                    Share King Bloggers with your friends and support independent creators!
                  </p>
                </div>
                ...
                <div className="mb-4 grid grid-cols-4 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-medium text-white/70">Twitter</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-medium text-white/70">Telegram</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-medium text-white/70">Facebook</span>
                  </button>
                </div>
                ...
                <p className="mt-4 text-center text-xs text-white/40">
                  Press <kbd className="rounded bg-white/10 px-1.5 py-0.5 font-mono text-[10px]">Esc</kbd> or click outside to close
                </p>
              </div>
            </div>
            </motion.div>
