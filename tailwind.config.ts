...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'sovereign-gradient': 'linear-gradient(135deg, #FF8C00 0%, #FFA500 100%)',
        'glass-gradient': 'linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.02) 100%)',
        'mesh-dark': 'radial-gradient(at 0% 0%, rgba(255, 140, 0, 0.15) 0, transparent 50%), radial-gradient(at 100% 100%, rgba(0, 0, 0, 1) 0, transparent 50%)',
      },
      borderRadius: {
